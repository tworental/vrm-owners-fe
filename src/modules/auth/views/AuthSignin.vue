    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 col-lg-5">
          <div class="auth--form">
            <v-form @submit="onSubmit" name="signin" v-slot="{ isSubmitting, errors }" v-e2e>
              <legend class="auth--title">{{ $t('auth.welcomeBack') }}</legend>
              <legend class="auth--title__subtitle">{{ $t('auth.welcomeBackSub') }}</legend>

              <div class="mb-3">
                <label for="inputEmail" class="form-label">{{ $t('auth.emailAddress') }}</label>
              ...
              <div class="mb-3">
                <label for="inputPassword" class="form-label">{{ $t('auth.password') }}</label>
              ...
              <button class="btn btn-primary btn-submit" :disabled="isSubmitting" type="submit" v-e2e="'signin'">
                <span
        ...
        <div class="col-12 col-lg-7">
          <div class="auth--bg">
            <img :src="require('@/assets/images/auth-bg.png')" alt="bg" />
          </div>
        </div>
      </div>
    </div>
